    ...
    <footer className="footer">
      <div className="footer-cont">
        <div className="footer-item">
          ...
          <p className="footer-desc">Tu lugar ideal para jugar, entrenar y equiparte con lo mejor. Todo lo que necesitás para tu pasión por el fútbol.</p>
        </div>
        <div className="footer-item">
        ...
        <div className="footer-item">
          ...
          <nav className="footer-nav">
            <ul className="footer-list">
              ...
              <li><Link className="navigation" to="/contact">Contacto</Link></li>
            </ul>
          </nav>
        </div>
        <div className="footer-item">
          ...
          <ul className="footer-list">
            <li><a className="navigation" target="_blank" rel="noreferrer" href="https://www.instagram.com/">Instagram</a></li>
            <li><a className="navigation" target="_blank" rel="noreferrer" href="https://www.facebook.com/">Facebook</a></li>
            <li><a className="navigation" target="_blank" rel="noreferrer" href="https://x.com/">Twitter</a></li>
          </ul>
        </div>
      </div>
